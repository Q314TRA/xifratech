                                                ...
                                                <SwiperSlider settings={slider} className="header-top-info-slider-wrap">
                                                    <div className="item">
                                                        <InfoItem>
                                                            ...
                                                            <InfoContent>
                                                                <Heading {...infoHeading}>Cra 41 #960 Poblado</Heading>
                                                                <Text {...infoText}>Medellin - Antioquia</Text>
                                                            </InfoContent>
                                                        </InfoItem>
                                                    </div>
                                                    <div className="item">
                                                        <InfoItem>
                                                            ...
                                                            <InfoContent>
                                                                ...
                                                                <Text {...infoText}>Lunes a Viernes</Text>
                                                            </InfoContent>
                                                        </InfoItem>
                                                    </div>
                                                    <div className="item">
                                                        <InfoItem>
                                                            ...
                                                            <InfoContent>
                                                                <Heading {...infoHeading}>Atención 24/7</Heading>
                                                                <Text {...infoText}>(+57) 300 485-9118</Text>
                                                            </InfoContent>
                                                        </InfoItem>
                                                    </div>
                                                    <div className="item">
                                                        <InfoItem>
                                                            ...
                                                            <InfoContent>
                                                                <Heading {...infoHeading}>(+57) 300 485-9118</Heading>
                                                                <Text {...infoText}>contacto@xifratech.com</Text>
                                                            </InfoContent>
                                                        </InfoItem>
                                                    </div>
                                                </SwiperSlider>
